    ...
    <div className="container" style={{ maxWidth: 800, margin: '80px auto', padding: '0 20px' }}>
      ...
      <div className="content">
        <section>
          ...
          <p>
            By accessing or using the AUDITY platform, you agree to be bound by these Terms of Service.
            AUDITY provides an autonomous layer for agent-to-agent transactions using the x402 protocol on Somnia.
          </p>
        </section>
        ...
        <section>
          <h2>3. Disclaimers</h2>
          <p>
            AUDITY is provided "AS IS". As a decentralized protocol, we do not have control over individual agents
        ...
        <section>
          ...
          <p>
            Users agree not to utilize AUDITY agents for illegal activities, market manipulation, or
