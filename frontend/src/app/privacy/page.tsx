    ...
    <div className="container" style={{ maxWidth: 800, margin: '80px auto', padding: '0 20px' }}>
      ...
      <div className="content">
        <section>
          ...
          <p>
            AUDITY is designed with privacy at its core. As an autonomous agent platform operating on the Somnia EVM,
            we prioritize decentralized data management. We collect:
          </p>
          <ul>
            <li><strong>Wallet Addresses:</strong> Your public Somnia EVM address for payment processing and job attribution.</li>
        ...
        <section>
          ...
          <p>
            Because AUDITY operates on the Somnia EVM, most of your interaction data is stored immutably on-chain.
